...
public class DrinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (iter.hasNext())
        {
            ...
            if (shopItem == null || shopItem.getCategoryID() != Setting.DRINK_CATEGORY)
            {
                iter.remove();
                continue;
            }
    ...
    private void render()
    {
        ...
        // adapter
        adapter = new UserItemAdapter(this, R.layout.shopitem_list_view, items, Setting.DRINK_CATEGORY);
        ...
        lvItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                {
                    Toast.makeText(DrinkActivity.this, R.string.item_out, Toast.LENGTH_SHORT).show();
                    return;
                }

                // Ask permission
                AlertDialog.Builder dialog = new AlertDialog.Builder(DrinkActivity.this);
